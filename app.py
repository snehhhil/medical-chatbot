...
FILE = "/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/models/data.pth"
...
diseases_description = pd.read_csv("/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/data/symptom_Description.csv")
diseases_description['Disease'] = diseases_description['Disease'].apply(lambda x: x.lower().strip(" "))

disease_precaution = pd.read_csv("/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/data/symptom_precaution.csv")
disease_precaution['Disease'] = disease_precaution['Disease'].apply(lambda x: x.lower().strip(" "))

symptom_severity = pd.read_csv("/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/data/Symptom-severity.csv")
symptom_severity = symptom_severity.map(lambda s: s.lower().strip(" ").replace(" ", "") if type(s) == str else s)


with open("/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/data/list_of_symptoms.pickle", "rb") as data_file:
    symptoms_list = pickle.load(data_file)

with open("/Users/snehillsinghh/Documents/VS Code/Medical Chatbot [END 2 END] [NLP]/models/fitted_model.pickle2", "rb") as modelFile:
